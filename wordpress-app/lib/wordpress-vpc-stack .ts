...
export class WordpressVpcStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new cdk.CfnOutput(this, 'CustomALBSGOutput', {
    ...
    new cdk.CfnOutput(this, 'CustomEC2SGOutput', {
    ...
    new cdk.CfnOutput(this, 'CustomRDSSGOutput', {
    ...
    new cdk.CfnOutput(this, 'CustomRDSSubnetDroupOutput', {
